...
class _SelectCountryScreenState extends State<SelectCountryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        backgroundColor: QuickHelp.isDarkMode(context) ? Color(0xFF000000) : Color(0xFFFFFFFF),
        appBar: AppBar(
          automaticallyImplyLeading: false,
          leading: TextButton(onPressed: ()=> QuickHelp.goBackToPreviousPage(context),
          child: TextWithTap("done".tr(), color: QuickHelp.isDarkMode(context) ? Color(0xFFFFFFFF) : Color(0xFF000000),),
          ),
          actions: [
            TextWithTap(
              "leaders.menu_clear_all".tr(),
              color: QuickHelp.isDarkMode(context) ? Color(0xFFFFFFFF) : Color(0xFF000000),
              marginTop: 20,
              marginRight: 15,
              onTap: (){
                setState(() {
                              ...
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  ...
                                  child: Row(
                                    children: [
                                      ContainerCorner(
                                        color: countrySelectedList.contains(snapshot.data![index]["cca2"]) ? Color(0xFF15CC79): Color(0xFFFFFF),
                                        borderColor: Color(0xFF15CC79),
                                        height: 15,
                                        width: 15,
                                        borderRadius: 50,
                                        marginBottom: 10,

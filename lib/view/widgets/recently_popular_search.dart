                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  searchController.recentPopular[index].getFirstName!,
                                  style: TextStyle(
                                ...
                                GetBuilder<UserViewModel>(
                                    ...
                                    return GestureDetector(
                                      onTap: () {
                                        userViewModel.followOrUnFollow(searchController.recentPopular[index].objectId!);
                                      },
                                      child: Container(
                                        width: 36.w,
                                        height: 20.h,
                                        ...
                                        child: Center(
                                          child: Text(
                                            userViewModel.currentUser.getFollowing!.contains(searchController.recentPopular[index].objectId) ? "✓" : "+",

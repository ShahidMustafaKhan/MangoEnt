            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: ()=> Get.toNamed(AppRoutes.profileScreen, arguments: {"otherProfile" : false}),
                      child: Container(
                        height: 88.h,
                        width: 88.w,
                        decoration: BoxDecoration(
                          ...
                          border:
                          Border.all(color: AppColors.yellowBtnColor, width: 2),
                        ),
                        child: ClipRRect(
                        ...
                        GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                  height: 27.w, width: 27.w,
                                  child: Image.asset(icon1, fit: BoxFit.cover,)),
                              SizedBox(height: 18.h),
                            ],
                          ),
                        ),
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            QuickHelp.getAgeFromDate(userViewModel.currentUser.getBirthday!).toString(),
                            style: TextStyle(
                              fontSize: 9.sp,
                    ...
                    if(userViewModel.currentUser.getHideMyLocation==false)
                      SvgPicture.asset(
                      QuickActions.getCountryFlag(userViewModel.currentUser),
                      height: 17.h,
                      width: 24.w,
                    ),
                  ],

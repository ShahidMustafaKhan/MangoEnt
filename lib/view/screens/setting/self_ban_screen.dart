                ...
                child: Column(
                  children: [
                    ...
                    PrimaryButton(
                        ...
                        height: 48.h,
                        borderRadius: 35.r,
                        title: userViewModel.currentUser.getSelfBanStatus ? "Remove Ban" : "Self Ban",
                        textColor: Color(0xff1E2121),
                        bgColor: AppColors.yellowBtnColor,
                        onTap: () {
                          QuickActions.showAlertDialog(context,
                              userViewModel.currentUser.getSelfBanStatus ? "Are you sure you want to remove ban?" : "Are you sure you want to self ban?",
                                  () {
                                    Get.back();

                    ...
                    builder: (context, coHostList, _) {
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          if((liveViewModel.isMultiGuest || (liveViewModel.isSingleLive && length!=0) ) && liveViewModel.role == ZegoLiveRole.audience && widget.isProfileUser==false)
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Text('Lv.${userViewModel.level}', style: sfProDisplayMedium.copyWith(color: AppColors.greyText)),
                                const Spacer(),
                                Text('EXP  ${userViewModel.xp}/5000', style: sfProDisplayMedium.copyWith(color: AppColors.greyText)),
                                          ...
                                          if(selectedGift.isNotEmpty) {
                                            if (Get
                                              ...
                                              if (battleViewModel != null &&
                                                  battleViewModel!.isBattleView == true) {
                                                if (all == true) {
                                                  battleViewModel!.sendGiftToAllTeams(
                                                      gift: selectedGift,
                                                  ...
                                                  if (isFirstUserSelected == true)
                                                    battleViewModel!.sendGiftToTeamA(
                                                        gift: selectedGift,
                                                        audio: selectedGiftMp3,
                                                        coins: int.parse(
                                                            selectedQuantity) *
                                                    ...
                                                    battleViewModel!.sendGiftToTeamB(
                                                        gift: selectedGift,
                                                        audio: selectedGiftMp3,
                                                        coins: int.parse(
                                                            selectedQuantity) *

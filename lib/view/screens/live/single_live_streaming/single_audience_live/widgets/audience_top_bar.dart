                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        widget.liveViewModel.liveStreamingModel.getAuthor!.getCoins.toString() ,
                                        style: sfProDisplayMedium.copyWith(
                                          fontSize: 12,
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              if(widget.battleViewModel.isBattleView==false && widget.liveViewModel.role==ZegoLiveRole.audience)
              GestureDetector(
                onTap: (){
                  showModalBottomSheet(
                    context: context,

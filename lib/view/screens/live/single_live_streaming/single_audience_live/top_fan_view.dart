              ...
              children: [
                ...
                Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(50),
                        child: Image.network(ranking[0].getGifter!.getAvatar!.url!, fit: BoxFit.contain, width: 64, height: 64),
                      ),
                    ),
                  ],
                ),
                Text(ranking[0].getGifter!.getFullName ?? '', style: sfProDisplayMedium.copyWith(fontSize: 14)),
                        ...
                        return Row(
                          ...
                          children: [
                            ...
                            CircleAvatar(
                              ...
                              backgroundImage: NetworkImage(gifter.getAvatar!.url!),
                            ),
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Image.asset(AppImagePath.gemStone, height: 15, width: 15),
                                    const SizedBox(width: 5),
                                    Text('LV.${gifter.getLevel ?? 1}', style: sfProDisplayRegular.copyWith(fontSize: 10)),
                                  ],
                                ),
                              ),
                            ),
                ...
                return Column(
                  children: [
                    ...
                    NothingIsHere(height: 170.h, width: 160.w,)
                  ],
                );
          }
        ),

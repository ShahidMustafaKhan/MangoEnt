...
final String img2url;
   oneonone({required this.img1url,required this.img2url});

  @override
  _oneononeState createState() => _oneononeState();
}

class _oneononeState extends State<oneonone> with TickerProviderStateMixin {

...
class oneontwo extends StatefulWidget {
  String img1url;
  String img2url;
  String img3url;
   oneontwo({required this.img1url,required this.img2url,required this.img3url});

  @override
  oneontwoState createState() => oneontwoState();
}

class oneontwoState extends State<oneontwo> with TickerProviderStateMixin {

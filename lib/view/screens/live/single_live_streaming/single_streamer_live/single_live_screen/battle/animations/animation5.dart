...
class threeonthree extends StatefulWidget {
  String img1url;
  String img2url;
  String img3url;
   threeonthree({required this.img1url,required this.img2url,required this.img3url});

  @override
  threeonthreeState createState() => threeonthreeState();
}

class threeonthreeState extends State<threeonthree> with TickerProviderStateMixin {

...
class twoontwo extends StatefulWidget {
  String img1url;
  String img2url;
  String img3url;
  String img4url;
   twoontwo({required this.img1url,required this.img2url, required this.img3url, required this.img4url});

  @override
  twoontwoState createState() => twoontwoState();
}

class twoontwoState extends State<twoontwo> with TickerProviderStateMixin {

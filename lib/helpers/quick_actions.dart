...
class QuickActions {
  ...
  static Widget profileImage(String imageUPath, {double? borderRadius = 0, BoxFit? fit = BoxFit.cover, double? width, double? height, EdgeInsets? margin}) {
    return Container(
      margin: margin,
      width: width,
      height: height,
          ...
          child: Dialog(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Lottie.asset(
                    'assets/animation/payment_success.json', // Replace with your Lottie animation file
                    width: 100,
                    height: 100,
                    repeat: false,
                    fit: BoxFit.cover,
  ...
  static Future<void> showPaymentConfirmationSheet(BuildContext context, double fem, double ffem, Function() confirm, {bool subscription=false, bool byDiamond=false}) async {
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(
            builder: (BuildContext context, StateSetter setModalState /*You can rename this!*/) {
              return Container(
                padding: EdgeInsets.fromLTRB(21*fem, 21.26*fem, 17*fem, 12.14*fem),
                width: 376*fem,
                height: 284*fem,
                child: Column(
                  children: [
                      ...
                      children: [
                        ...
                        Align(
                          child: SizedBox(
                            height: 22*fem,
                            child: Text(
                              subscription ? byDiamond ? '300' : "7,99 \$" :'30',
                              style: SafeGoogleFont (
                                'DM Sans',
                                fontSize: 16*ffem,
  ...
  static void showCongratulationsDialog(BuildContext context, double fem, double ffem, {String description='Your account is ready to use', Function()? onPressedDone}) {
    showDialog(
      useSafeArea: false,
      context: context,
      builder: (BuildContext context) {
  ...
  static Widget myAvatar(double fem, double ffem, UserModel currentUser, {double height= 141 , double width=141, double padding=16}){
    return Visibility(
      ...
      child: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
                fit: BoxFit.cover,
                image: AssetImage("assets/avatar/avatarFrame${currentUser.getAvatarId}.png")
            )
        ),
        height: height*fem,
        width: width*fem,
  ...
  static Future<void> privateKeyDialog(BuildContext context,double fem,double ffem, TextEditingController privateKeyController, Function() onCancel, Function() onContinue, {bool set=true}) async {
      ...
      builder: (BuildContext context) {
        return Dialog(
          ...
          child: Container(
            ...
            width:325*fem,
            // pop59A (1:4055)
            padding: EdgeInsets.fromLTRB(20*fem, 20*fem, 25*fem, 20*fem),
            decoration: BoxDecoration (
              color: Color(0xffffffff),
                ...
                Column(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(22.92*fem, 0, 0*fem, 0*fem),
                      height: 34*fem,
                      width: double.infinity,
                      decoration: BoxDecoration (
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                if (value.isEmpty) {
                                  ...
                                  errorText.value = 'Private Key should be 6+ characters';
                                }
                                else{
                                  errorText.value= '';
                                }
                              ...
                              decoration: InputDecoration(
                                ...
                                contentPadding: EdgeInsets.fromLTRB(0, 0, 0, 10.5*fem),
                      ...
                      InkWell(
                        onTap: (){
                          if(errorText.value.isNotEmpty){
                            QuickHelp.showAppNotificationAdvanced(title: errorText.value, context: context);
                          }
                          else if(privateKeyController.text==''){
                            QuickHelp.showAppNotificationAdvanced(title: "Private Key is required", context: context);
  ...
  static Future<void> paidEntryDialog(BuildContext context,double fem,double ffem, TextEditingController diamondEntryController, Function() onCancel, Function() onContinue, {bool set=true}) async {
    RxString errorText=''.obs;
    return showDialog(
      context: context,
      builder: (BuildContext context) {
                ...
                Column(
                  ...
                  children: [
                    Container(
                      ...
                      // statusdefaulttypepasswordstate (1:1662)
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 0*fem),
                      padding: EdgeInsets.fromLTRB(22.92-12*fem, 0, 0*fem, 0*fem),
                      height: 34*fem,
                      width: double.infinity,
                      decoration: BoxDecoration (
                        color: Colors.grey.shade100,
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            // iconlyboldlockf9P (I1:1662;124:252)
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 14.92-4*fem, 1.5*fem),
                            width: 31.14*fem,
                            height: 31.14*fem,
                            child: Image.asset(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                if (value.isEmpty) {
                                  ...
                                  errorText.value = 'Amount should be greater than zero';
                                }
                                else{
                                  errorText.value= '';
                                }
  ...
  static Future<void> confirmPaymentDialog(BuildContext context,double fem,double ffem, int amount, Function() onContinue) async {
    return showDialog(
      context: context,
      builder: (BuildContext context) {
        return Dialog(
          ...
          child: Container(
            ...
            width:325*fem,
            // pop59A (1:4055)
            padding: EdgeInsets.fromLTRB(20*fem, 20*fem, 25*fem, 19*fem),
            decoration: BoxDecoration (
              color: Color(0xffffffff),
              borderRadius: BorderRadius.circular(20*fem),
            ),
            child: Column(
              ...
              children: [
                Container(
                  // areyousureyouwanttodisconnecta (1:4057)
                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 6*fem, 36*fem),
                  constraints: BoxConstraints (
                    maxWidth: 252*fem,
                  ),
                  child: Text(
  ...
  static Widget myWishBroadcasterWidget(double fem,double ffem, BuildContext context, UserModel currentUser, LiveStreamingModel liveStreamingModel,{double? bottom, double? right, double? top, double? left}){
    return Positioned(
      ...
      child: InkWell(
        onTap:(){
          QuickActions.myWishListBroadcaster(fem, ffem, context,liveStreamingModel);
        },
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Container(
                // ZbD (1:24747)
                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 11.13*fem, 6.43*fem),
                width: 38.87*fem,
                height: 24.57*fem,
                child: Image.asset(
                  'assets/dino/-qZZ.png',
  ...
  static Widget myWishAudienceWidget(double fem, double ffem, BuildContext context, UserModel broadcasterModel,UserModel currentUser, LiveStreamingModel liveStreamingModel ,{double? bottom, double? right, double? top, double? left}){
    return Positioned(
      ...
      right: right==null ? null : right,
      child: Visibility(
        visible: liveStreamingModel.getMyWishList!=null && liveStreamingModel.getMyWishList!.length>0,
        child: InkWell(
          onTap:(){
            myWishListAudience(fem, ffem, context,broadcasterModel,currentUser, liveStreamingModel);
          },
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Container(
                  // 5Qb (1:23872)
                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 3.13*fem, 0.43*fem),
                  width: 38.87*fem,
                  height: 24.57*fem,
                  child: Image.asset(
                    'assets/dino/-qZZ.png',
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(14 * fem), // 14% of screen width
                          color: Color(0xFF777777), // Background color
                        ),
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(14 * fem), // 14% of screen width
                          child: LinearProgressIndicator(
                            value: QuickActions.wishListProgressValue(liveStreamingModel), // Change this value to set the progress
                            backgroundColor: Colors.transparent,
                            valueColor: AlwaysStoppedAnimation<Color>(Color(0xFFFFBD2B)), // Active color
                          ),
                        ),
                      ),
                    ],
  ...
  static double wishListProgressValue(LiveStreamingModel liveStreamingModel){
    ...
    if(liveStreamingModel.getMyWishList != null){
      for(int i=0; i < liveStreamingModel.getMyWishList!.length; i++){
        totalReceived=totalReceived+double.parse(liveStreamingModel.getMyWishList![i][LiveStreamingModel.keyReceived]);
        totalAmount=totalAmount+double.parse(liveStreamingModel.getMyWishList![i][LiveStreamingModel.keyAmount]);
      }
  ...
  UserModel broadcasterModel, UserModel currentUser, LiveStreamingModel liveStreamingModel){
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: GridView.builder(
                            ...
                            itemCount: wishList.length, // Set itemCount to the number of items you have
                            itemBuilder: (BuildContext context, int index) {
                              return Container(
                                padding: EdgeInsets.fromLTRB(9*fem, 2.12*fem, 9.58*fem, 3.46*fem),
                                width: 106.58*fem,
                                height: 140.58*fem,
                                decoration: BoxDecoration (
                                ...
                                child: Column(
                                  ...
                                  children: [
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    margin: EdgeInsets.fromLTRB(7*fem, 0*fem, 10*fem, 0*fem),
                                                    width: double.infinity,
                                                    child: Row(
                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                      children: [
                                                        Opacity(
                                                          ...
                                                          opacity: 0.9,
                                                          child: Container(
                                                            margin: EdgeInsets.fromLTRB(0*fem, 1.19*fem, 2.73*fem, 0*fem),
                                                            width: 12.27*fem,
                                                            height: 9*fem,
                                                            child: Image.asset(
                                            ...
                                            child: Align(
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  border: Border.all(color: Color(0xff50b0ed),width: 1),
                                                ),
                                                child: LinearProgressIndicator(   //audience
                                                  backgroundColor: Color(0xff777777),
                                                  valueColor: AlwaysStoppedAnimation<Color>(Color(0xff50b0ed)),
                                                  value: double.parse(wishList[index][LiveStreamingModel.keyReceived])/double.parse(wishList[index][LiveStreamingModel.keyAmount]) , // Set the value of the progress bar (between 0.0 and 1.0)
                                    ...
                                    Container(
                                      // buttonWh5 (1:24897)
                                      margin: EdgeInsets.fromLTRB(int.parse(wishList[index][LiveStreamingModel.keyAmount])<=int.parse(wishList[index][LiveStreamingModel.keyReceived])? 5*fem : 18*fem, 0*fem, int.parse(wishList[index][LiveStreamingModel.keyAmount])<=int.parse(wishList[index][LiveStreamingModel.keyReceived])?0:24.47*fem, 0*fem),
                                      width: double.infinity,
                                      height: 22*fem,
                                      decoration: BoxDecoration (
                                        borderRadius: BorderRadius.circular(24*fem),
                                      ...
                                      child: Stack(
                                        children: [
                                          Positioned(
                                            ...
                                            child: Align(
                                              child: SizedBox(
                                                width: int.parse(wishList[index][LiveStreamingModel.keyAmount])<=int.parse(wishList[index][LiveStreamingModel.keyReceived])?45.53+30*fem : 45.53*fem,
                                                height: 18*fem,
                                                child: Container(
                                                  decoration: BoxDecoration (
                                                    borderRadius: BorderRadius.circular(24*fem),
                                                    border: Border.all(color: const Color(0xff50b0ed)),
                                                    gradient: const LinearGradient (
                                                      begin: Alignment(0, -1),
                                                      end: Alignment(0, 1),
                                                      colors: <Color>[Color(0xff3d8ee1), Color(0xff68c5e2)],
                                          ...
                                          Positioned(
                                            ...
                                            child: Align(
                                              child: InkWell(
                                                onTap:(){
                                                  if(currentUser.getDiamondsTotal! >= 3){
                                                    if(int.parse(wishList[index][LiveStreamingModel.keyAmount])!=int.parse(wishList[index][LiveStreamingModel.keyReceived])) {
                                                      Map<String,
                                                          dynamic> item = {
                                                        LiveStreamingModel
                                                      ...
                                                      setModalState(() {});
                                                        liveStreamingModel
                                                            .setMyWishWholeList =
                                                            wishList;
                                                        liveStreamingModel.addDiamonds=3;
                                                        liveStreamingModel
                                                            .save().then((
                                                            value) {
                                                          currentUser
                                                    ...
                                                    QuickHelp.showAppNotificationAdvanced(title: 'Insufficient diamonds!', context: context);
                                                  }


                                                },
                                                child: SizedBox(
                                                  width:  int.parse(wishList[index][LiveStreamingModel.keyAmount])<=int.parse(wishList[index][LiveStreamingModel.keyReceived]) ? 25+30 : 25*fem,
                                                  height: 22*fem,
                                                  child: Text(
                                                    int.parse(wishList[index][LiveStreamingModel.keyAmount])<=int.parse(wishList[index][LiveStreamingModel.keyReceived]) ? 'Completed' : 'Send',
                                                    textAlign: TextAlign.center,
                                                    style: SafeGoogleFont (
                                                      'DM Sans',
                                                      fontSize: 10*ffem,
  ...
  static myWishListBroadcaster(double fem,double ffem, BuildContext context, LiveStreamingModel liveStreamingModel){
        ...
        return StatefulBuilder(
            builder: (BuildContext context, StateSetter setModalState /*You can rename this!*/) {
              ...
              for (int i = 0; i < wishItems.length; i++) {
                temp=temp+(int.parse(wishItems[i][LiveStreamingModel.keyAmount])*3);
                      ...
                      child: Container(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                              ...
                              child: Stack(
                                children: [
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            margin: EdgeInsets.fromLTRB(7*fem, 0*fem, 14*fem, 0*fem),
                                            width: double.infinity,
                                            child: Row(
                                              crossAxisAlignment: CrossAxisAlignment.center,
                                              children: [
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          borderRadius: BorderRadius.circular(14 * fem),
                                          child: LinearProgressIndicator(
                                            backgroundColor: Color(0xff777777), // Background color of the progress bar
                                            valueColor: AlwaysStoppedAnimation<Color>(Color(0xff50b0ed)), // Color of the progress indicator
                                            value: double.parse(wishItems[index][LiveStreamingModel.keyReceived])/double.parse(wishItems[index][LiveStreamingModel.keyAmount]) , // Set the value of the progress bar (between 0.0 and 1.0)
                                          ),
                                        ),
                                      ),
                                    ),
                                  ...
                                  Positioned(
                                    ...
                                    child: InkWell(
                                      onTap: (){
                                        liveStreamingModel.removeMyWishList=wishItems[index];
                            ...
                            InkWell(
                              onTap: (){
                                QuickActions.myWishListOptionsBroadcaster(fem, ffem, context, liveStreamingModel).then((value) => setModalState((){}));
                              },
                              child: Container(
  ...
  static Future myWishListOptionsBroadcaster(double fem,double ffem, BuildContext context, LiveStreamingModel liveStreamingModel){
    int selected= -1;
    int amount=1;
    String category='popular';
    List images=['assets/dino/heart.png','assets/dino/cake.png','assets/dino/car.png',
      'assets/dino/parachute.png','assets/dino/play.png','assets/dino/castle.png','assets/dino/iloveyou.png',"assets/dino/-Yw9.png"];
    return showModalBottomSheet(
      isScrollControlled: true,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(
                      ...
                      height: 73*fem,
                      child: Container(
                          padding: EdgeInsets.fromLTRB(25*fem, 2*fem, 19.27*fem, 0),
                          decoration: BoxDecoration (
                                ...
                                InkWell(
                                  onTap: (){
                                    ...
                                    if(selected!=-1){
                                      ...
                                      liveStreamingModel.save().then((value) => QuickHelp.goBack(context));
                                    }
                                    else{
                                      QuickHelp.goBack(context);
                                    }
                    ...
                    Expanded(
                      child: Container(
                        padding: EdgeInsets.fromLTRB(4*fem, 0*fem, 0*fem, 33-13*fem),
                        width: 555*fem,
                          ...
                          children: [
                                ...
                                children: [
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Container(
                                        // frame3955Nf (1:21157)
                                        padding: EdgeInsets.fromLTRB(0*fem, 51.19-20*fem, 0*fem, 49.81-20-10-10*fem),
                                        width: double.infinity,
                                        height: double.infinity,
                                        decoration: BoxDecoration (
                                          borderRadius: BorderRadius.circular(21*fem),
                                            ...
                                            InkWell(
                                              ...
                                              child: Text(
                                                ...
                                                style: SafeGoogleFont (
                                                  ...
                                                  color: category=="popular" ? Color(0xffffffff) : Color(0xff777777),
                                                ),
                                              ),
                                            ),
                                            InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: SafeGoogleFont (
                                                    ...
                                                    fontWeight: FontWeight.w700,
                                                    height: 1.0769230769*ffem/fem,
                                                    color: category=="special" ? Color(0xffffffff) : Color(0xff777777),
                                                  ),
                                                ),
                                              ),
                                            ),
                                              ...
                                              child: Container(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: SafeGoogleFont (
                                                    ...
                                                    fontWeight: FontWeight.w700,
                                                    height: 1.0769230769*ffem/fem,
                                                    color: category=="vip" ? Color(0xffffffff) : Color(0xff777777),
                                                  ),
                                                ),
                                              ),
                                            ),
                                              ...
                                              child: Container(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: SafeGoogleFont (
                                                    ...
                                                    fontWeight: FontWeight.w700,
                                                    height: 1.0769230769*ffem/fem,
                                                    color: category=="classic" ? Color(0xffffffff) : Color(0xff777777),
                                                  ),
                                                ),
                                              ),
                                            ),
                                            InkWell(
                                              ...
                                              child: Text(
                                                ...
                                                style: SafeGoogleFont (
                                                  ...
                                                  fontWeight: FontWeight.w700,
                                                  height: 1.0769230769*ffem/fem,
                                                  color: category=="new" ? Color(0xffffffff) : Color(0xff777777),
                                                ),
                                              ),
                                            ),
                                          ],
                            ...
                            SizedBox(
                              ...
                              child:GridView.builder(
                                ...
                                itemCount: 6, // Set itemCount to the number of items you have
                                itemBuilder: (BuildContext context, int index) {
                                  return InkWell(
                                    onTap: (){
                                      selected=index;
                                    ...
                                    child: Container(
                                      ...
                                      height: 149.51 * fem,
                                      decoration:  BoxDecoration(
                                        border:selected==index ? Border.all(color: Color(0xFF57AAFF) , width: 3) : null,
                                      ...
                                      child: Stack(
                                        children: [
                                            ...
                                            child: Visibility(
                                              ...
                                              child: Container(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Container(
                                                    decoration: BoxDecoration (
                                                      border: Border.all(color: Color(0xff3991ec)),
                                                      borderRadius: BorderRadius.only (
                                                    ...
                                                    child: Center(
                                                      child: Text(
                                                        ...
                                                        style: SafeGoogleFont (
                                                          'DM Sans',
                                                          fontSize: amount==200 ? 12*fem : 15*ffem ,
                                                          fontWeight: FontWeight.w700,
                                                          height: 1.4666666667*ffem/fem,
                                                          color: Color(0xffffffff),
                                                        ),
                                          ...
                                          Container(
                                            padding: EdgeInsets.fromLTRB(10.52 * fem, selected==index ? 5.58 : 14.58 * fem, 16.9 * fem, 0),
                                            child: Column(
                                              crossAxisAlignment: CrossAxisAlignment.center,
                                              children: [
                                                Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        margin: EdgeInsets.fromLTRB(0.18 * fem, 0 * fem, 0* fem, 0 * fem),
                                                        width: double.infinity,
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            Opacity(
                                                              ...
                                                              opacity: 0.9,
                                                              child: Container(
                                                                margin: EdgeInsets.fromLTRB(0 * fem, 0.21 * fem, 5.85 * fem, 0 * fem),
                                                                width: 17.53 * fem,
                                                                height: 11.7 * fem,
                                                                child: Image.asset(
                                                                  'assets/dino/gemstones.png',
                            ...
                            Container(
                              // dotsgf9 (1:21195)
                              margin: EdgeInsets.fromLTRB(171*fem, 12*fem, 0*fem, 17.1*fem),
                              width: 31.04*fem,
                              height: 6.9*fem,
                              color: Colors.transparent,
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: (){
                                      if(selected!=-1){
                                        ...
                                        QuickHelp.showAppNotificationAdvanced(title: "Please select an item!", context: context);
                                      }
                                    },
                                    child: Container(
                                      ...
                                      height: 29*fem,
                                      decoration: BoxDecoration (
                                        border: selected!=-1 && amount==1 ? Border.all(color: Color(0xFF57AAFF),width: 2): null,
                                        color: Color(0xff605b69),
                                      ...
                                      child: Center(
                                        child: Text(
                                          ...
                                          style: SafeGoogleFont (
                                            ...
                                            color: selected!=-1 && amount==1 ?Color(0xffffffff):Color(0xff9e9e9e),
                                          ),
                                        ),
                                      ),
                                    ),
                                  ...
                                  InkWell(
                                    ...
                                    child:Container(
                                      ...
                                      height: 29*fem,
                                      decoration: BoxDecoration (
                                        border: selected!=-1 && amount==5 ? Border.all(color: Color(0xFF57AAFF),width: 2): null,
                                        color: Color(0xff605b69),
                                        borderRadius: BorderRadius.circular(16*fem),
                                      ),
                                      child: Center(
                                        child: Text(
                                          ...
                                          style: SafeGoogleFont (
                                            ...
                                            fontWeight: FontWeight.w700,
                                            height: 0.8235294118*ffem/fem,
                                            color: selected!=-1 && amount==5 ?Color(0xffffffff):Color(0xff9e9e9e),
                                          ),
                                        ),
                                      ),
                                    ),
                                  ...
                                  InkWell(
                                    ...
                                    child:Container(
                                      ...
                                      height: 29*fem,
                                      decoration: BoxDecoration (
                                        border: selected!=-1 && amount==10 ? Border.all(color: Color(0xFF57AAFF),width: 2): null,
                                        color: Color(0xff605b69),
                                        borderRadius: BorderRadius.circular(16*fem),
                                      ),
                                      child: Center(
                                        child: Text(
                                          ...
                                          style: SafeGoogleFont (
                                            ...
                                            fontWeight: FontWeight.w700,
                                            height: 0.8235294118*ffem/fem,
                                            color: selected!=-1 && amount==10 ?Color(0xffffffff):Color(0xff9e9e9e)
                                          ),
                                        ),
                                      ),
                                    ),
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      height: 29*fem,
                                      decoration: BoxDecoration (
                                        border: selected!=-1 && amount==50 ? Border.all(color: Color(0xFF57AAFF),width: 2): null,
                                        color: Color(0xff605b69),
                                        borderRadius: BorderRadius.circular(16*fem),
                                      ),
                                      child: Center(
                                        child: Text(
                                          ...
                                          style: SafeGoogleFont (
                                            ...
                                            fontWeight: FontWeight.w700,
                                            height: 0.8235294118*ffem/fem,
                                            color: selected!=-1 && amount==50 ?Color(0xffffffff):Color(0xff9e9e9e)
                                          ),
                                        ),
                                      ),
                                    ),
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      height: 29*fem,
                                      decoration: BoxDecoration (
                                        border: selected!=-1 && amount==200 ? Border.all(color: Color(0xFF57AAFF),width: 2): null,
                                        color: Color(0xff605b69),
                                        borderRadius: BorderRadius.circular(16*fem),
                                      ),
                                      child: Center(
                                        child: Text(
                                          ...
                                          style: SafeGoogleFont (
                                            ...
                                            fontWeight: FontWeight.w700,
                                            height: 0.8235294118*ffem/fem,
                                            color: selected!=-1 && amount==200 ?Color(0xffffffff):Color(0xff9e9e9e)
                                          ),
                                        ),
                                      ),
                                    ),
  ...
  static Widget goalWidget(double fem,double ffem, BuildContext context,
       LiveStreamingModel liveStreamingModel,{double? left,  double? top, double? right, double? bottom }){
    return Positioned(
      left:  left ,
      top: top ,
      bottom: bottom ,
      right: right ,
      child: Visibility(
        visible: liveStreamingModel.getGoal!=null && liveStreamingModel.getGoal!=0,
        child: liveStreamingModel.getDiamonds!/liveStreamingModel.getGoal!>=1.0 ? QuickActions.goalCompletedWidget(fem, ffem, context, liveStreamingModel) :
        Container(
          // licv3 (5:38216)
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                height: 5 * fem,
                margin: EdgeInsets.fromLTRB(2.11*fem, 2*fem, 0*fem, 1*fem),
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(14 * fem),
                ),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(14 * fem),
                  child: LinearProgressIndicator(
                    minHeight: 5 * fem, // Set the height
                    backgroundColor: const Color(0xFF777777), // Set the inactive color
                    valueColor: const AlwaysStoppedAnimation<Color>(Color(0xFFFFBD2B)), // Set the active color
                    value: liveStreamingModel.getDiamonds!/liveStreamingModel.getGoal!, // Set the value of the progress (0.0 to 1.0)
              ...
              Container(
                ...
                margin: EdgeInsets.fromLTRB(1.71*fem, 0*fem, 44.52*fem, 0*fem),
                padding: EdgeInsets.fromLTRB(0*fem, 3*fem, 2*fem, 3*fem),
                width: double.infinity,
                height: 22*fem,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Container(
                      // goaltHD (5:38232)
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 1.29*fem, 0*fem),
                      child: Text(
                        'Goal:',
                        style: SafeGoogleFont (
                          'Fredoka',
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(1.88*fem, 2.65*fem, 3.87*fem, 0*fem),
                      width: 11.25*fem,
                      height: 8.25*fem,
                      child: Image.asset(
                        'assets/dino/gemstones.png',
  ...
  static Widget goalCompletedWidget(double fem,double ffem, BuildContext context,
      ...
      child: Visibility(
        ...
        child: Column(
          children: [
            Container(
              // liasy (5:39974)
              padding: EdgeInsets.fromLTRB(6*fem, 9*fem, 4.57*fem, 0*fem),
              width: 141*fem,
              decoration: BoxDecoration (
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    // dividerUVV (5:39981)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 1.43*fem, 0.49*fem),
                    width: 129*fem,
                    height: 1*fem,
                    child: Image.asset(
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 7.43*fem, 0*fem),
                    padding: EdgeInsets.fromLTRB(2*fem, 2*fem, 0*fem, 3*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 3.87*fem, 0.15*fem),
                                width: 11.25*fem,
                                height: 8.25*fem,
                                child: Image.asset(
                                  'assets/dino/gemstones.png',
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(
            builder: (BuildContext context, StateSetter setModalState /*You can rename this!*/) {
              ...
              return Container(
                padding: EdgeInsets.fromLTRB(8*fem, 5.41*fem, 0*fem, 22*fem),
                width: 375*fem,
                height: 490*fem,
                decoration: BoxDecoration (
                  color: const Color(0xffffffff),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(9*fem, 0*fem, 153.88*fem, 6.49*fem),
                      width: double.infinity,
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          InkWell(
                            ...
                            child: Container(
                              // iconsHVR (4:34645)
                              margin: EdgeInsets.fromLTRB(0*fem, 14.11*fem, 124*fem, 0*fem),
                              width: 20*fem,
                              height: 19.29*fem,
                              child: Image.asset(
                    ...
                    Container(
                      // recentHtj (4:34631)
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 33.92*fem),
                      child: Text(
                        'Your goal',
                        style: SafeGoogleFont (
                          'DM Sans',
                    ...
                    Container(
                      // recentoMH (4:34644)
                      margin: EdgeInsets.fromLTRB(3*fem, 0*fem, 0*fem, 34.65*fem),
                      child: Text(
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 15*fem, 40*fem),
                      width: 350*fem,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Obx(() {
                              return Container(
                                ...
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    amountWidget(fem, ffem, 10,amount.value==10,amount,other),
                                    SizedBox(
                                      width: 7*fem,
                                    ),
                                    amountWidget(fem, ffem, 50,amount.value==50,amount,other),
                                    SizedBox(
                                      width: 7*fem,
                                    ),
                                    amountWidget(fem, ffem, 100,amount.value==100,amount,other),
                                  ],
                                ),
                              );
                            }
                          ...
                          Obx(() {
                              return SizedBox(
                                ...
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    amountWidget(fem, ffem, 200,amount.value==200,amount,other),
                                    SizedBox(
                                      width: 7*fem,
                                    ),
                                    amountWidget(fem, ffem, 1000, amount.value==1000,amount,other),
                                    SizedBox(
                                      width: 7*fem,
                                    ),
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        height: double.infinity,
                                        decoration: BoxDecoration (
                                          gradient: other.value ? const LinearGradient (
                                          begin: Alignment(0, -1),
                                          end: Alignment(0, 1),
                                          colors: <Color>[Color(0xff3d8ee1), Color(0xff68c5e2)],
                                          stops: <double>[0, 1],
                                        ) : null,
                                          border: other.value ? null : Border.all(color: Color(0xffe0e0e0)),
                                          borderRadius: BorderRadius.circular(10*fem),
                                        ),
                                        child: Container(
                    ...
                    InkWell(
                      onTap: (){
                        if(other.value==true){
                          QuickHelp.goBack(context);
                          QuickActions.otherAmount(fem, ffem, context, liveStreamingModel);
                        }
                        else{
                          QuickHelp.goBack(context);
                          QuickActions.addGoalMessage(fem, ffem, context, liveStreamingModel,amount.value);
                        }
                      },
                      child: Container(
                        // buttonqVZ (4:34646)
                        margin: EdgeInsets.fromLTRB(50*fem, 0*fem, 54*fem, 0*fem),
                        width: double.infinity,
                        height: 48*fem,
  ...
  static Widget amountWidget(double fem, double ffem, int amount, bool active, RxInt selectedAmount, RxBool other){
    return InkWell(
      onTap:(){
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(8*fem, 0*fem, 16*fem, 8*fem),
                      width: double.infinity,
                      height: 42*fem,
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Container(
                            // iconso7u (5:35687)
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 38*fem, 5.68*fem),
                            width: 20*fem,
                            height: 19.29*fem,
                            child: Image.asset(
                              'assets/dino/back_black.png',
                          ...
                          Container(
                            ...
                            padding: EdgeInsets.fromLTRB(10*fem, 9*fem, 10*fem, 13*fem),
                            width: 207*fem,
                            height: double.infinity,
                            decoration: BoxDecoration (
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                isCollapsed: true, // Set isCollapsed to true
                          ...
                          InkWell(
                            onTap:(){
                              if(textEditingController.text.isEmpty){
                                QuickHelp.showAppNotificationAdvanced(title: 'Please Input number!', context: context);
                              }
                              else if(textEditingController.text=='0'){
                                QuickHelp.showAppNotificationAdvanced(title: 'Number must be greater than zero!', context: context);
                              }
                              else{
                                QuickHelp.goBack(context);
                                QuickActions.addGoalMessage(fem, ffem, context, liveStreamingModel, int.parse(textEditingController.text));
                              }
                            },
                            child: Container(
                              // buttonYDu (5:35688)
                    ...
                    Container(
                      // goalpopJMV (5:35692)
                      padding: EdgeInsets.fromLTRB(18*fem, 20*fem, 19*fem, 19*fem),
                      width: double.infinity,
                      height: 287*fem,
                      decoration: BoxDecoration (
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(115.33*fem, 0*fem, 0*fem, 0*fem),
                              width: double.infinity,
                              height: 56*fem,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.center,
        ...
        return StatefulBuilder(
            builder: (BuildContext context, StateSetter setModalState /*You can rename this!*/) {
              return Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom*0.44),
                  child: Container(
                    padding: EdgeInsets.fromLTRB(17*fem, 5*fem, 15*fem, 22*fem),
                    width: 375*fem,
                    height: 453*fem,
                    decoration: BoxDecoration (
                      color: Color(0xffffffff),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 146.88*fem, 6*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Container(
                                // iconsZLb (5:36554)
                                margin: EdgeInsets.fromLTRB(0*fem, 14.51*fem, 124*fem, 0*fem),
                                width: 20*fem,
                                height: 19.29*fem,
                                child: Image.asset(
                        ...
                        Container(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                if (value.isEmpty) {
                                  errorText.value= 'Please provide a message; it cannot be left empty';
                                }
                                else if (value.length>40) {
                                  errorText.value= 'Your message must be under 40 characters.';
                                }
                                else{
                                  errorText.value= '';
                                }
                        ...
                        InkWell(
                          onTap: () async {
                            if(textEditingController.text.isEmpty){
                              QuickHelp.showAppNotificationAdvanced(title: 'Please provide a message; it cannot be left empty', context: context);
                            }
                              ...
                              liveStreamingModel.setGoalTitle=textEditingController.text;
                              ...
                              if(response.success){
                                ...
                                QuickHelp.showAppNotificationAdvanced(title: 'Something went wrong. Plz try again later', context: context);
                              }
                            }
                          },
                          child: Container(
                            // button1kK (5:36550)
                            margin: EdgeInsets.fromLTRB(41*fem, 0*fem, 47*fem, 0*fem),
                            width: double.infinity,
                            height: 48*fem,
                            decoration: BoxDecoration (
                            ),

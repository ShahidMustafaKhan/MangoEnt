...
class AppColors {
  static const darkBGColor = Color(0xff1E1F1F);
  ...
  static Color txtBtnColor = const Color(0xFFF9C034).withOpacity(0.7);
  static Color yellowColor = const Color(0xFFFFBD2B);
  static Color greyColor = const Color(0xFF777777);
  static Color lightOrange = const Color(0xFFFEB749);
  static Color yellowBtnColor = const Color(0xFFF9C034);
  ...
  static final blurYellow20 = const Color(0xffF9C034).withOpacity(0.2);

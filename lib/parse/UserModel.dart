...
class UserModel extends ParseUser implements ParseCloneable {
  ...
  DateTime? get getVipSubscriptionDate => get<DateTime>(keyLastSubscriptionDate);
  set setVipSubscriptionDate(DateTime date) => set<DateTime>(keyLastSubscriptionDate, date);
  ...
  set setAvatarSelected(bool selected) => set<bool>(keyIsAvatarSelected, selected);
  ...
  set setEducation(List<Map<String,dynamic>> education) => set<List<Map<String,dynamic>>>(keyEducation, education);
  ...
  set setCareer(List<Map<String,dynamic>> career) => set<List<Map<String,dynamic>>>(keyCareer, career);
